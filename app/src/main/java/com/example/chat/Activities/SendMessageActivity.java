...
import com.example.chat.Utils.AESUtils;
import com.example.chat.Utils.AppSharedPreferences;
import com.example.chat.Utils.ImageCompressor;
import com.example.chat.Utils.LoadingDialog;
import com.example.chat.NotificationReq;
import com.example.chat.NotificationRequest;
import com.example.chat.NotificationResponce;
import com.example.chat.R;
import com.example.chat.RetrofitClient;
import com.example.chat.Adapters.SendMessageAdapter;
import com.example.chat.Models.SendMessageModel;
import com.example.chat.Adapters.UserProfileDetailsAdapter;
...
import static com.example.chat.Constants.BASE_URL;
 ...
 PushDownAnim.setPushDownAnimTo(choose_img).setOnClickListener(view -> { onSlideViewButtonClick(layout); });
        ...
        childLayout.setOnClickListener(v -> {
            ...
            if (model.getType().equals("image")){
                System.out.println("rehan   " + recyclerView.getAdapter().getItemCount());
