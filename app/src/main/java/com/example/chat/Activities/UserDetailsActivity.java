...
public class UserDetailsActivity extends AppCompatActivity {
    ...
    private void uploadFile(String name) {
        if (mImageUri!=null){
            ...
            final StorageReference reference = mStorageRef.child("profileImage/"+System.currentTimeMillis() );
            ...
            FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() {
                ...
                public void onComplete(@NonNull @NotNull Task<String> task) {
                    if (task.isComplete()){
                        String token = task.getResult();
                        String string_null_image = "https://firebasestorage.googleapis.com/v0/b/chat-3171d.appspot.com/o/logo.png?alt=media&token=bb9990e5-089b-4e7c-8f99-d195f980973c";
    ...
    private void uploadData(String imageUrl, String token,String name,LoadingDialog loadingDialog) {
        ...
        ref.child("Info").setValue(map).addOnCompleteListener(task -> {
            ...
            mdToast.show();
            Intent intent1 = new Intent(UserDetailsActivity.this, MainActivity.class);
